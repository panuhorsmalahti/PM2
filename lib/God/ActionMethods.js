...
module.exports = function(God) {
   ...
   */
  God.notifyKillPM2 = function(opts, cb) {
  ...
  God.duplicateProcessId = function(id, cb) {
    ...
    var proc = Common.serialize(God.clusters_db[id].pm2_env);
   ...
   * @return
   */
  God.stopWatch = function(opts, fn) {
    var env = null;
    ...
    try {
      ...
      console.error('Old PM2 running in memory please upgrade');
   ...
   * @return
   */
  God.restartWatch = function(opts, fn) {
    var env = null;
